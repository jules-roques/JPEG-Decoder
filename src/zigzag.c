...
uint8_t * descente_diag_1(uint8_t i, uint8_t j, uint8_t k, uint16_t* vect, uint16_t** tab)
{
    while (j != 0) {
        tab[i][j] = vect[k];
        i++;
...
uint8_t * descente_grande_diag(uint8_t i, uint8_t j, uint8_t k, uint16_t* vect, uint16_t** tab)
{
    while (j != 0) {
        tab[i][j] = vect[k];
        i++;
...
uint8_t * montee_diag_1(uint8_t i, uint8_t j, uint8_t k, uint16_t* vect, uint16_t** tab)
{
    while (i != 0) {
        i--;
        j++;
...
uint8_t * montee_diag_2(uint8_t i, uint8_t j, uint8_t k, uint8_t n,uint16_t* vect, uint16_t** tab)
{
    j++;
    k++;
    tab[i][j] = vect[k];
...
uint8_t * descente_diag_2(uint8_t i, uint8_t j, uint8_t k, uint8_t n,uint16_t* vect, uint16_t** tab)
{
    i++;
    tab[i][j] = vect[k];
    k++;
...
uint16_t** reordonnancement_zigzag(uint16_t* vect, uint8_t n)
{
    ...
    /* on initialise les indices i et j de la matrice à remplir et k qui parcourt les éléments de vect */
    uint8_t i = 0;
    uint8_t j = 1;
    uint8_t k = 1;
    uint8_t* indices;
