...
/*
    Verifie le nom du fichier passé en argument (inspiré de la solution Stack Overflow)
...
/*
    change l'extension du fichier passé en argument (inspiré de la solution Stack Overflow)
*/
...
*/
float **matrix_uint16_to_float(uint16_t **matrix_uint, uint16_t nb_lignes, uint16_t nb_colonnes)
{
...
*/
void affiche_tab_uint8(char *alinea, uint8_t nb_vals_ligne, uint8_t *tab, uint16_t nb_elems)
{
    if (tab == NULL) {
...
(pour un afficage propre)
*/
void affiche_tab_uint16(char *alinea, uint8_t nb_vals_ligne, uint16_t *tab, uint16_t nb_elems)
{
    if (tab == NULL) {
        print_error(stderr, "Tableau vide passé en argument\n");
    }
...
(pour un afficage propre)
*/
void affiche_tab_uint32(char *alinea, uint8_t nb_vals_ligne, uint32_t *tab, uint16_t nb_elems)
{
    if (tab == NULL) {
        print_error(stderr, "Tableau vide passé en argument\n");
    }
...
void affiche_tab_float(char *alinea, uint8_t nb_vals_ligne, float *tab, uint16_t nb_elems)
{
    if (tab == NULL) {
        print_error(stderr, "Tableau vide passé en argument\n");
    }
...
(pour un afficage propre)
*/
void affiche_matrice_uint8(char *alinea, uint8_t nb_lignes, uint8_t nb_colonnes, uint8_t **matrice)
{
    if (matrice == NULL) {
...
(pour un afficage propre)
*/
void affiche_matrice_uint16(char *alinea, uint8_t nb_lignes, uint8_t nb_colonnes, uint16_t **matrice)
{
    if (matrice == NULL) {
        print_error(stderr, "Matrice vide passée en argument\n");
    }
...
(pour un afficage propre)
*/
void affiche_matrice_uint32(char *alinea, uint8_t nb_lignes, uint8_t nb_colonnes, uint32_t **matrice)
{
    if (matrice == NULL) {
        print_error(stderr, "Matrice vide passée en argument\n");
    }
...
void affiche_matrice_float(char *alinea, uint8_t nb_lignes, uint8_t nb_colonnes, float **matrice)
{
    if (matrice == NULL) {
        print_error(stderr, "Matrice vide passée en argument\n");
    }
